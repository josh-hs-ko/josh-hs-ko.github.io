...
publicationList =
  ...
  , Publication
      ...
      , links   = [ ("PDF", Nothing, "https://arxiv.org/pdf/2503.04001")
                  , ("Agda code", Just "HTML", "/Agda/BT/BinomialTabulation.html")
                  ]
      , info    = [ ("DOI", "10.48550/arXiv.2503.04001", Nothing)
                  , ("Agda version", "2.6.4.3 with Standard Library 2.0", Nothing)
                  , ("Related blog posts", "0034, 0036", Nothing)
                  , ("Note", "Sections 1 and 2 of this paper are extracted, simplified, and rewritten as a <a href=\"#publication-1c6f4237\">functional pearl</a>.", Nothing)
  ...
  , Publication
      ...
      , info    = [ ("LNCS", "14576", Nothing)
                  , ("Pages", "115–142", Nothing)
                  , ("DOI", "10.1007/978-3-031-57262-3_5", Nothing)
                  , ("Abstract", "There has been much progress in designing bidirectional type systems and associated type synthesis algorithms, but mainly on a case-by-case basis. To remedy the situation, this paper develops a <em>general</em> and <em>formal</em> theory of bidirectional typing for simply typed languages: for every signature that specifies a mode-correct bidirectionally typed language, there exists a <em>proof-relevant</em> type synthesiser which, given an input abstract syntax tree, constructs a typing derivation if any, gives its refutation if not, or reports that the input does not have enough type annotations. Sufficient conditions for deriving a type synthesiser such as soundness, completeness, and mode-correctness are studied universally for all signatures. We propose a preprocessing step called <em>mode decoration</em>, which helps the user to deal with missing type annotations. The entire theory is formally implemented in Agda, so we provide a <em>verified</em> generator of proof-relevant type synthesisers as a by-product of our formalism.", Nothing)
                  ]
      }
   , Publication
  ...
  , Publication
      ...
      , info    = [ ("DOI", "10.48550/arXiv.2110.01465", Nothing)
  ...
  , Publication
      ...
      , info    = [ ("Volume",  "5", Nothing)
                  ...
                  , ("Agda version", "2.6.1 with Standard Library 1.3", Nothing)
  ...
  , Publication
      ...
      , links   = [ ("PDF", Nothing, "https://www.usenix.org/system/files/osdi20-chang.pdf")
                  ...
                  , ("Agda code", Just "HTML", "/Agda/OSDI20/SnapshotConsistency.html")
                  ]
  ...
  , Publication
      ...
      , info    = [ ("DOI", "10.48550/arXiv.2001.02031", Nothing)
  ...
  , Publication
      ...
      , info    = [ ("PACMPL", "2 (POPL)", Nothing)
                  ...
                  , ("Agda version", "2.5.2 with Standard Library 0.13", Nothing)
  ...
  , Publication
      ...
      , info    = [ ("Volume", "27", Nothing)
                  ...
                  , ("Agda version", "2.5.1.1 with Standard Library 0.12", Nothing)
...
--    }
  , Publication
      ...
      , info    = [ ("Pages", "61–72", Nothing)
                  ...
                  , ("Agda version", "2.4.2.4 with Standard Library 0.11", Nothing)
  ...
  , Publication
      ...
      , info     = [ ("Pages", "37–48", Nothing)
                   ...
                   , ("Agda version", "2.3.3 with Standard Library 0.6", Nothing)
