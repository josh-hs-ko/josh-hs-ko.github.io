...
publicationList =
  ...
  , Publication
      ...
      , links   = [ ("PDF", Just "draft proceedings", "https://bx-community.wdfiles.com/local--files/bx2021:program/AKL21.pdf")
                  ]
