...
I wonder if we can turn this reasoning pattern into some form of reusable theorem so that in the future we can simply say that unique inhabitance of `ReverseType` (or, for example, of the type of `retabulate` in the [binomial tabulation](/#publication-1c6f4237) development) is a corollary of the theorem (otherwise it’s not really science…).
...
**Agda file:** [WG21-Sep25.agda](WG21-Sep25.agda)<br>
**Follow-up:** [0048 (Specifying queue order using parametric types, abstractly)](/blog/0048/)
