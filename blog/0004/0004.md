...
My colleague [Yun-Sheng Chang](https://scholar.google.com/citations?user=KuJajQ4AAAAJ) came up with a way to eliminate the $\exists j$ quantification, which looks like a form of [Skolemisation](https://en.wikipedia.org/wiki/Skolem_normal_form) to me, and I decided to try to apply a more standard version of Skolemisation.
